<?php 
	...
	$pms = $db->fetch_all_data("pms_nokia_before",[],"pms_id='".$pms_id."'");
	
	if(isset($_POST["save"])){
		$db->addtable("pms_nokia_before");
		...
		if($inserting["affected_rows"] >= 0){
			...
			javascript("window.location=\"pms_nokia_add_03.php?token=".$token."&pms_id=".$pms_id."\";");
			exit();
		} else {
...
<center><h5><u>BEFORE</u></h5></center>
...
<table width="100%"align="center" border="0">
	...
	<tr>	
		<td colspan="3" style="padding-top:15;">	
			<?=$f->input("back","Back","type='button' onclick='window.location=\"pms_nokia_photo.php?token=".$token."&pms_id=".$pms_id."&page=02\";'","btn btn-warning");?>
			<?php if(!$pms[0]["id"]) { ?>
			...
			<?php } else {?>
				...
				&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
				<?=$f->input("nest","Next","type='button' onclick='window.location=\"pms_nokia_photo.php?token=".$token."&pms_id=".$pms_id."&page=03\";'","btn btn-info");?>
			<?php } ?>
		</td>
	</tr>
</table>
