...
<?php if(!$_isexport){ ?>
	<html>
		<head>
			...
			<style>
				@font-face {
				  font-family: 'NokiaNokkok';
				  src: url('font/NokiaNokkok.ttf')  format('truetype'); /* Safari, Android, iOS */
				}
				@font-face {
				  font-family: 'NokiaPureHeadline-Light';
				  src: url('font/NokiaPureHeadline-Light.ttf')  format('truetype'); /* Safari, Android, iOS */
				}
				@font-face {
		...
		<body id="bodyid" style="margin:0px;">
			...
			<!-- Start reCAPTCHA -->
				...
				<?php
					$__data_sitekey 	= "6LeO8NoUAAAAAHj6OYRduSGtpHMR_GFDvvEC0ufc";
					$__data_secretKey	= "6LeO8NoUAAAAAK8IXj7sWgKtaeUspzv4GhdT6ouo";
				
					 if($_SERVER[HTTP_HOST] == $__dIP){
						 javascript("window.location='".str_replace($__dIP,$__Domain_Name,$__dUrl)."';");
					 }
				?>
			<!-- END reCAPTCHA -->
			<?php
